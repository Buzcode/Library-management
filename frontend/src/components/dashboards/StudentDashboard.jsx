    ...
    useEffect(() => {
        if (user) {
            const fetchFines = async () => {
                ...
                try {
                    // --- FIX: The URL is now correctly wrapped in backticks (`) to form a template string ---
...
// --- FIX: Removed the duplicate "export" keyword ---
